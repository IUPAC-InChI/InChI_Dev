                                           ...
                                           int vABParityUnknown )
{
    ...
    int i1, n1, s2, i2;  /*  n1 must be SIGNED integer */
    ...
    /* djb-rwth: initialisation of neigh required to avoid undefined array subscript */
    for (i2 = 0; i2 < 3; i2++)
    {
        neigh[i2] = 0;
    }
                                             ...
                                             int vABParityUnknown )
{
    ...
    int i, k, ret1, ret2, ret_failed = 0, mode, max_mode, i2;
