 ...
 * Version 1
 * Software version 1.05 (pre-release, updated)
 * December 20, 2016
 *
...
The program uses Python 3; tested with Python 3.4.2 64 bit under Windows 7 64bit 
...
Note that this Python program should not be used as a production InChI generator. 
