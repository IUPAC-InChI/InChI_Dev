...
/* Remove leading & trailing spaces; replace consecutive spaces with a    
   single space. Treat non-printable characters (Greeks) as spaces.	*/
...
/*
    Implement non-ANSI C functions:
        __MYTOLOWER
        memicmp
        stricmp 
        _strnset 
