...
/****************************************************************************/
int NormalizeAndCompare( CANON_GLOBALS *pCG, INCHI_CLOCK *ic, 
                         ...
                         ALL_TC_GROUPS *pTCGroups, INChI *pInChI[], 
...
/****************************************************************************/
int RunBnsRestore1( CANON_GLOBALS *pCG, INCHI_CLOCK *ic, ICHICONST INPUT_PARMS *ip, STRUCT_DATA *sd, BN_STRUCT *pBNS, BN_DATA *pBD,
...
repeat_for_new_metals:
    ...
    pBNS->ulTimeOutTime = NULL; /* TODO: Correct this. ulTimeOutTime;*/	/* v. 1.05 */
    pBNS->ic = ic;								/* v. 1.05 */
...
/****************************************************************************/
int OneInChI2Atom( INCHI_CLOCK *ic, CANON_GLOBALS *pCG, ICHICONST INPUT_PARMS *ip_inp, STRUCT_DATA *sd, const char *szCurHdr, long num_inp,
...
/********************************************************************************************/
int AddRemProtonsInRestrStruct( INCHI_CLOCK *ic, CANON_GLOBALS *pCG, ICHICONST INPUT_PARMS *ip_inp,  STRUCT_DATA *sd, long num_inp,
                                int bHasSomeFixedH,
...
/**********************************************************************************/
int AddRemIsoProtonsInRestrStruct( INCHI_CLOCK *ic, CANON_GLOBALS *pCG, ICHICONST INPUT_PARMS *ip_inp,  STRUCT_DATA *sd, long num_inp, int bHasSomeFixedH,
                                   StrFromINChI *pStruct, int num_components,
                                   StrFromINChI *pStructR, int num_componentsR,
