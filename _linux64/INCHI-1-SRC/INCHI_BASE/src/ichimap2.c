...
int SetNewRanksFromNeighLists4( CANON_GLOBALS *pCG, 
                                int num_atoms, NEIGH_LIST *NeighList, AT_RANK *nRank,
...
int SetNewRanksFromNeighLists( CANON_GLOBALS *pCG, 
                               int num_atoms, NEIGH_LIST *NeighList, 
                               AT_RANK *nRank, AT_RANK *nNewRank,
                               AT_RANK *nAtomNumber, int bUseAltSort, 
...
/**************************************************************************************/
int parity_of_mapped_atom2( CANON_GLOBALS *pCG, int from_at, int to_at, 
                            const sp_ATOM *at, EQ_NEIGH *pEN,
                            const AT_RANK *nCanonRankFrom, const AT_RANK *nRankFrom, 
...
int map_an_atom2( CANON_GLOBALS *pCG, 
                  int num_atoms, int num_max, int at_no1/*from*/, int at_no2/*to*/,
                  AT_RANK *nTempRank,
...
int RemoveCalculatedNonStereoBondParities( CANON_GLOBALS *pCG, 
                                           sp_ATOM *at, int num_atoms, int num_at_tg,
                                           AT_RANK **pRankStack1, 
                                           AT_RANK **pRankStack2, AT_RANK *nTempRank, NEIGH_LIST *NeighList,
                                           AT_RANK *nCanonRank, 
                                           const AT_RANK *nSymmRank,
                                           AT_RANK *nAtomNumberCanon, 
                                           AT_RANK *nAtomNumberCanon1, 
