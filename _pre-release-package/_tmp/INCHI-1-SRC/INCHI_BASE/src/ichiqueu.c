...
{   
    ...
    *pnNumBondPos  = 0;
    ...
    nRet = DFS_FindTautInARing( pCG, 
                                atom, nStartAtom, nStartAtomNeighbor,
...
int nGet12TautIn5MembAltRing( struct tagCANON_GLOBALS *pCG, 
                              inp_ATOM *atom, int nStartAtom, int nStartAtomNeighbor,
                              ...
                              struct BalancedNetworkData *pBD, int num_atoms )
{
    ...
    *pnNumBondPos  = 0;
    ...
    nRet = DFS_FindTautInARing( pCG, 
                                atom, nStartAtom, nStartAtomNeighbor, -1, -1, 5,
                                nDfsPathPos, DfsPath,
...
int nGet15TautIn6MembAltRing( struct tagCANON_GLOBALS *pCG,
                              inp_ATOM *atom, int nStartAtom, AT_RANK  *nDfsPathPos,
                              ...
                              struct BalancedNetworkData *pBD, int num_atoms )
{
    ...
    *pnNumBondPos  = 0;
    ...
    nRet = DFS_FindTautInARing( pCG, 
                                atom, nStartAtom, -1/*nStartAtomNeighbor*/, -1/*nStartAtomNeighbor2*/,
...
int Check6MembTautRing( struct tagCANON_GLOBALS *pCG, 
                        inp_ATOM *atom, DFS_PATH *DfsPath, int nLenDfsPath, int nStartAtomNeighbor,
...
int Check15TautPath( struct tagCANON_GLOBALS *pCG, 
                     inp_ATOM *atom, DFS_PATH *DfsPath, int nLenDfsPath, int jNxtNeigh, int nStartAtomNeighbor,
                     int nStartAtomNeighbor2, int nStartAtomNeighborNeighbor,
                     T_ENDPOINT *EndPoint, int nMaxNumEndPoint,
                     T_BONDPOS  *BondPos, int nMaxNumBondPos,
                     int *pnNumEndPoint, int *pnNumBondPos,
