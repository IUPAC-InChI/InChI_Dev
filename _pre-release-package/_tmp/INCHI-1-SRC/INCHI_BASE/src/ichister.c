...
static int Get2DTetrahedralAmbiguity( CANON_GLOBALS *pCG, double at_coord[][3], int bAddExplicitNeighbor, int bFix2DstereoBorderCase );
...
static int set_stereo_atom_parity( CANON_GLOBALS *pCG, sp_ATOM *out_at, inp_ATOM *at, int cur_at, inp_ATOM *at_removed_H, int num_removed_H, 
                                  int bPointedEdgeStereo, int vABParityUnknown );
/*
int set_stereo_parity( CANON_GLOBALS *pCG, inp_ATOM* at, sp_ATOM* at_output, int num_at, int num_removed_H,
...
int GetStereocenter0DParity( CANON_GLOBALS *pCG, 
                             inp_ATOM *at, int cur_at, int j1, 
                             AT_NUMB nSbNeighOrigAtNumb[], int nFlag )
{
...
int set_stereo_atom_parity( CANON_GLOBALS *pCG, sp_ATOM *out_at, inp_ATOM *at, int cur_at, inp_ATOM *at_removed_H,
                            int num_removed_H, int bPointedEdgeStereo, int vABParityUnknown)
{
    ...
    for ( k = 0, j1 = 0; k < 2; k ++ ) {
        ...
        case 0:
            ...
            for ( j = 0; j < num_explicit_H; j ++, j1 ++ ) {
                ...
                z = -get_z_coord( at, (int) (at_removed_H-at)+ next_at, 
                                  0 /*neighbor #*/, 
                                  &nType, 
                                  -(bPointedEdgeStereo & PES_BIT_POINT_EDGE_STEREO) );
                switch ( nType ) {
    ...
    if ( b2D ) 
    {
        ...
        n2DTetrahedralAmbiguity = Get2DTetrahedralAmbiguity( 
                                    pCG, at_coord, bAddExplicitNeighbor, 
