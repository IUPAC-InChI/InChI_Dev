...
/*	
    Output isotopic abs stero inversion substring of the whole structure InChI string
*/
...
/*	
    Produce tetr stereo inversion substring of AuxInfo.
*/
int str_AuxInvSp3( INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, 
                   INCHI_IOSTREAM_STRING *strbuf, int *bOverflow, int bOutType, 
                   int TAUT_MODE, int num_components,
...
/*	
    Produce tetr stereo inversion numbering substring of AuxInfo.
*/
...
*/
int str_AuxInvIsoSp3( INCHI_SORT *pINChISort, INCHI_SORT *pINChISort2, 
                      INCHI_IOSTREAM_STRING *strbuf,
