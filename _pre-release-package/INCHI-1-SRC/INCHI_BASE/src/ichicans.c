...
int SetKnownStereoBondParities( CANON_GLOBALS *pCG, sp_ATOM *at, int num_atoms, const AT_RANK *nCanonRank,
...
int SetKnownStereoCenterParities( CANON_GLOBALS *pCG, sp_ATOM *at, int num_atoms, const AT_RANK *nCanonRank,
                                  const AT_RANK *nRank, const AT_RANK *nAtomNumber );
int RemoveKnownNonStereoCenterParities( CANON_GLOBALS *pCG, sp_ATOM *at, int num_atoms, const AT_RANK *nCanonRank,
...
int find_atoms_with_parity( sp_ATOM *at, S_CHAR *visited, 
                            int from_atom, int cur_atom )
{
    int i, next_atom;
...
int UnmarkNonStereo( CANON_GLOBALS *pCG, sp_ATOM *at, int num_atoms, 
                     const AT_RANK *nRank, const AT_RANK *nAtomNumber, int bIsotopic )
{
...
int FillSingleStereoDescriptors( CANON_GLOBALS *pCG, 
                                 ...
                                 int *nStereoDbleLen, int nMaxStereoDbleLen, 
                                 int bAllene )
{
