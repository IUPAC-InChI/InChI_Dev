...
* InChI stand-alone executable inchi-1[.exe] does not require dll/so libraries.

* To use the shared library, you may wish to create 'libinchi.so.1' 
as a symbolic link to 'libinchi.so.1.05.00'
