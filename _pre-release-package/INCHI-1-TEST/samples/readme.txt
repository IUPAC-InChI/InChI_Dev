...
structures drawn in InChI User's Guide and Technical Manual, as well as 
polymers (new in v. 1.05).
...
Polymers                        SUB-DIRECTORY
    pex.sdf                     Polymer examples corresponding to Table 2
                                of InChI v. 1.05 Release Notes (RelNotes.pdf)
